...
book_checkout_4 = BookCheckout.create!(client: client_user, book: book_1, status_id: BookCheckout.statuses[:returned])
book_checkout_5 = BookCheckout.create!(client: client_user, book: book_1, status_id: BookCheckout.statuses[:lent])
book_checkout_6 = BookCheckout.create!(client: client_user, book: book_2, status_id: BookCheckout.statuses[:lent])
book_checkout_7 = BookCheckout.create!(client: client_user, book: book_3, status_id: BookCheckout.statuses[:returned])
