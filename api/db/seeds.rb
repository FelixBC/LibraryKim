...
# Examples:
User.create!(email: "admin@admin.com", password: "admin", role_id: User.roles[:admin])
User.create!(email: "client@client.com", password: "client", role_id: User.roles[:client])
...
event_1 = Event.create!(name: "Book Fair",  event_date: "2021-11-01",description: "Used & New Book Fair!!", image_url: "https://www.abc-clio.com/wp-content/uploads/2019/04/", capacity: 100)
event_2 = Event.create!(name: "Adventurous Book Fair",  event_date: "2021-11-02",description: "Free Random book Fair!", image_url: "https://www.abc-clio.com/wp-content/uploads/2019/04/", capacity: 100)